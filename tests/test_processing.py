...
@pytest.fixture()
def dict_invalid() -> list:
    return [
        {"id": 594226727, "stat": "EXECUTED", "date": "2018-09-12T21:27:25.241689"},
...
def test_filter_by_state_invalid(dict_invalid: list) -> None:
    assert filter_by_state(dict_invalid, "EXECUTED") == []


@pytest.mark.parametrize(
    "list_dict, value, expected",
    [
        (
            [
                {"id": 41428829, "state": "EXECUTED", "date": "2019-07-03T18:35:29.512364"},
...
def test_filter_by_state_invalid_different(list_dict: list, value: str, expected: list) -> None:
    assert filter_by_state(list_dict, value) == expected


def test_sort_by_date_true() -> None:
    assert sort_by_date(
        [
            {"id": 41428829, "state": "EXECUTED", "date": "2019-07-03T18:35:29.512364"},
            {"id": 939719570, "state": "EXECUTED", "date": "2018-06-30T02:08:58.425572"},
...
def test_sort_by_date_true_same_dates() -> None:
    assert sort_by_date(
        [
            {"id": 41428829, "state": "EXECUTED", "date": "2019-07-03T18:35:29.512364"},
            {"id": 939719570, "state": "EXECUTED", "date": "2018-06-30T02:08:58.425572"},
